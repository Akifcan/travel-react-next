...
export const fetchPinsAsync = createAsyncThunk('pin/fetchPins', async _ => {
	const response = await fetchPins()
	return response
})

export const fetchListedPinsAsync = createAsyncThunk('pin/fetchListedPins', async _ => {
	const response = await fetchListedPins()
	return response
})

export const addNewPinAsync = createAsyncThunk('pin/addNewPin', async data => {
